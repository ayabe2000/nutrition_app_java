...
public class NutritionService {
    ...
    public Nutrition getTotalNutritionForUser(String username) {
        ...
        for (NutritionHistory nutritionHistory : userNutritions) {
            totalEnergy += nutritionHistory.getEnergy();
            totalProtein += nutritionHistory.getProtein();
            totalFat += nutritionHistory.getFat();
            totalCholesterol += nutritionHistory.getCholesterol();
            totalCarbohydrates += nutritionHistory.getCarbohydrates();
        }
